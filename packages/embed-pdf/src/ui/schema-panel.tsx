    ...
    if (content.type === 'tabs') {
      ...
      return (
        <>
          ...
          <div
            ref={panelRef}
            className={`fixed bottom-0 left-0 right-0 z-50 ${heightClass} flex flex-col rounded-t-2xl bg-background shadow-2xl transition-all duration-300`}
            style={{
          ...
          >
            ...
            >
              ...
              <button
                onClick={onClose}
                className="ml-2 rounded-full p-1 transition-colors hover:bg-accent/75 hover:text-accent-foreground"
                aria-label="Close panel"
              >
                <Icons.CloseIcon className="h-5 w-5 text-muted-foreground" />
              </button>
            </div>
