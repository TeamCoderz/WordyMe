      ...
      <div className="w-full max-w-md rounded-lg border border-amber-200 bg-amber-50 p-6">
        ...
        <div className="mt-4 flex justify-end gap-3">
          <button
            onClick={() => provides?.closeDocument(documentState.id)}
            disabled={isRetrying}
            className="rounded-md px-4 py-2 text-sm text-muted-foreground hover:bg-accent/75"
          >
            Cancel
          </button>
          <button
            ...
            className="rounded-md bg-accent px-4 py-2 text-sm text-accent-foreground hover:bg-accent/75 disabled:bg-muted-foreground disabled:text-muted-foreground"
          >
