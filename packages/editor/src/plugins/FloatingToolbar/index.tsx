...
import { getDOMRangeRect } from '@repo/editor/utils/getDOMRangeRect';
import { getSelectedNode } from '@repo/editor/utils/getSelectedNode';
import { setFloatingElemPosition } from '@repo/editor/utils/setFloatingElemPosition';
...
function useFloatingToolbar(editor: LexicalEditor, anchorElem: HTMLElement) {
