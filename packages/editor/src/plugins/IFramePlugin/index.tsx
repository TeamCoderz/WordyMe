...
import { $createIFrameNode, IFrameNode, IFramePayload } from '@repo/editor/nodes/IFrameNode';
  ...
  useEffect(() => {
    ...
    return editor.registerCommand<IFramePayload>(
      ...
      (payload) => {
        ...
        const autoLinkNode = $createAutoLinkNode(payload.src).append($createTextNode(payload.src));
        iFrameNode.append(autoLinkNode);
